...
class 클래스명:
    ...
    def 함수명(self, 매개변수, 매개변수=기본값, *매개변수):
        ...
        self.맴버변수 = 변경할 값 | 계산식
        return self.필드명 또는 return 결과 값
...
# 파이썬은 실행할 떄(동적으로) 멤버변수(필드) 를 추가할 수 있음
ref1.score = 100    # ref1 이 참조하는 인스턴스 안에 score 를 추가하고 100을 저장함
print('ref1 이 참조하는 객체 안의 score 필드 값 : ', ref1.score)
# print('ref2 이 참조하는 객체 안의 score 필드 값 : ', ref2.score)    # error
