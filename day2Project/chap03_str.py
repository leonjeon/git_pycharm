...
# 순차자료형은 값의 순번(인덱스, index) 이 매겨짐, 0부터 시작된다
...
# 문자열 반복 연산자 : * 반복할횟수
print('Hello!' * 3)     # Hello! 3번 반복

# 문자 처리 내장함수
# upper(), lower()  :   영문자일 때 대/소문자 변환하는 함수
tt = 'apple'
print(tt)
print(tt.upper()[0:3:2] * 2)
print(tt.lower()[::-1])

# 파이썬에서는 기록된 문자 값은 변경할 수 없음
# tt[1] = 'b'
...
tt3 = 'tEst stR pyTHon'
print(tt3)
print(tt3.swapcase())   # 소문자는 대문자, 대문자는 소문자로 변환 함수이다.
print(tt3.capitalize())     # 문장의 첫글자를 대문자를 변환, 나머지는 소문자로 변환하는 함수이다.
