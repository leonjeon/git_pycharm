...
# 여러 종류의 값들을 순차적으로 저장하는 집합자료형이다.
# 리스트와 다른점은 저장된 값은 변경할 수 없다. => 상수 개념이 적용된다, 연산 속도가 빠름
...
# 튜플도 리스트와 같이 인덱싱, 슬라이싱 연산 가능하다.
lst = [10, 20, 30]
tpl = (11, 22, 33)
print(lst, type(lst))
print(tpl, type(tpl))

print('0 번쨰 값 : ', lst[0], tpl[0])
print('0 번째 부터 1번째 까지의 값들 : ', lst[0:2], tpl[0:2])
print('리스트 합치기 : ', lst + lst)
print('튜플 합치기 : ', tpl + tpl)

# 튜플과 리스트의 차이점 : 튜플은 값 변경 못 한다.
lst[2] = 99
print('lst : ' , lst)
# tpl[2] = 15 # Error
# print('tpl : ', tpl) # TypeError: 'tuple' object does not support item assignment
...
# 튜플 생성 시 저장 데이터가 1개일 때는 소괄호 생략해도 된다.
tpl_5 = 1,
...
def f_test2() :
    return 1, 2, 3      # 원래 return 은 한개의 값만 리턴할 수 있는 것이 일반적이다.
